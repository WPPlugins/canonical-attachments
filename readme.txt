...
Donate link: https://www.hivedigital.com/2017/01/19/canonical-attachments-in-wordpress/
...
This plugin was developed by the good folks at [Hive Digital](https://www.hivedigital.com/ "Awesome Digital Marketing Agency")
 
== Screenshots ==
 
1. Main menu page offers options for bulk editing or individual editing to create canonicals for attachment files

2. Editor page for the uploads .htaccess file

3. Media pages have an input field for the canonical URL

4. Option to enter canonical url when you upload a file
